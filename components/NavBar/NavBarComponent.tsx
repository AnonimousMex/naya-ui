        ...
        <>
            ...
            <View className='absolute bottom-0 left-0 right-0 bg-white' >
                <View className='flex-row justify-around items-center h-[6rem] mx-4'>
                    ...
                    >
                        <View className='roudend-full mb-4'>
                            <Image source={ ICONS.REWARD_NAV_ICON } className={widthAndHeigth}/>
                        </View>
                    </TouchableOpacity>
                    <TouchableOpacity
                        onPress={() => {
                    ...
                    >
                        <View className={`rounded-full mb-4 w-11 h-11 ${bg} flex justify-center items-center overflow-hidden p-[0.5rem]`}>
                            <Image source={ IMAGES.HAPPY_LION_HEAD } className=' w-[140%] h-[110%] object-contain '/> 
