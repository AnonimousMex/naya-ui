      ...
      onPress: () =>
        openModal(
          ...
          <View className="space-y-4">
            <View className="mb-4">
              <Text className="text-gray-600 font-UrbanistMedium text-base mb-1">
                Nombre
              </Text>
              <Text className="text-gray-800 font-UrbanistBold text-lg">
                {userInfo?.name || "No disponible"}
              </Text>
            </View>
            <View className="mb-4">
              <Text className="text-gray-600 font-UrbanistMedium text-base mb-1">
            ...
            <View className="mb-4">
              ...
              <Text className="text-gray-800 font-UrbanistBold text-lg">
                {userInfo?.code_connection || "No disponible"}
              </Text>
            </View>
          </View>,
        ),
        ...
        openModal(
          ...
          <View className="space-y-4">
            <Text className="text-gray-700 font-Urbanist text-lg mb-4">
              En esta sección podrás configurar las opciones de seguridad de tu
              cuenta.
            </Text>
            <Text className="text-gray-600 font-Urbanist text-base">
              • Cambiar contraseña{"\n"}• Configurar autenticación de dos
    ...
    },
    {
      ...
      onPress: () =>
        openModal(
          ...
          <View className="space-y-4">
            <Text className="text-gray-700 font-Urbanist text-lg mb-4">
              Información sobre los términos y condiciones de uso de la
              plataforma.
            </Text>
            <Text className="text-gray-600 font-Urbanist text-base">
        ...
        >
          <View className="bg-blue-300 px-4 pt-5 pb-20 rounded-b-[15] relative">
            ...
            <Text className="text-white text-sm leading-5 font-UrbanistBold">
              Dentro de esta sección podrás gestionar toda tu información
              personal y configurar tu cuenta según tus preferencias.
            </Text>
          </View>
            ...
            >
              <View className="bg-white rounded-3xl px-6 py-6 max-w-md mx-auto shadow-lg">
                <View className="flex-row justify-between items-center mb-6">
                  ...
                  >
                    <Text className="text-gray-600 font-UrbanistBold text-2xl">
                      ×
                    </Text>
                  </TouchableOpacity>
                </View>
